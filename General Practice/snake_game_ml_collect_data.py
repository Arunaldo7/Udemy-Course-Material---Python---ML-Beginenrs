...
def exit_game():
    ...
    new_game_state_dataset = pd.DataFrame(game_state_list);
    
    old_game_state_dataset = pd.read_excel(current_directory_path + "game_state_dataset.xlsx");
    
    game_state_dataset = old_game_state_dataset.append(new_game_state_dataset);
    
    game_state_dataset.to_excel(current_directory_path + "game_state_dataset.xlsx", index = False);
...
player_stats_file = current_directory_path + "player_stats.pkl"
